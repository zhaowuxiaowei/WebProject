...
public class HelloServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        PrintWriter out = response.getWriter();
		   ...
		   Statement stmt = null;
	        ...
	        String username = "owyx4oyxl1";
	        String password = "2lil0j114zhwk52k02k3h545j20xw2w2m0h1250x";
	        //System.getenv("MYSQL_HOST_S"); 为从库，只读
	        String dbUrl = String.format("jdbc:mysql://%s:%s/%s","w.rdc.sae.sina.com.cn","3307","app_zhangning");
	        try {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String driver = "com.mysql.jdbc.Driver";
        String username = "35x34zn2zn";
        String password = "xw31zkwk23ljm3lx0khjykyyl1ywzi4i00hj53wk";
        //System.getenv("MYSQL_HOST_S"); 为从库，只读
